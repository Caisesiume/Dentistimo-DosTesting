# Distributed Systems - Dos Testing

DoS (Denail of Service) System for Testing and Practical demonstration of systems capability to handle a basic DDoS Attack
